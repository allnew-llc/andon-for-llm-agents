...
_EMOJI = {
    VaultEvent.SYNC_OK: ":white_check_mark:",
    VaultEvent.SYNC_FAIL: ":x:",
    VaultEvent.ROTATE: ":arrows_counterclockwise:",
    VaultEvent.ADD: ":heavy_plus_sign:",
    VaultEvent.REMOVE: ":heavy_minus_sign:",
    VaultEvent.AUDIT_DRIFT: ":warning:",
    VaultEvent.AUDIT_OK: ":shield:",
}
